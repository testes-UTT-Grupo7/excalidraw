...
- Name: visual.spec.ts >> Caso 2 — Menu Lateral >> 2.2 — Painel deve conter todas as opções de personalização
- Location: zTestesVisuais/testes-automatizados/visual.spec.ts:137:7
...
Call log:
  - waiting for locator('[data-testid="toolbar-rectangle"]')
    - locator resolved to <input type="radio" aria-label="Rectangle" aria-keyshortcuts="R or 2" name="editor-current-shape" data-testid="toolbar-rectangle" id="VBfYrYfuhVDwuK_JNj-xv-undefined" class="ToolIcon_type_radio ToolIcon_size_medium"/>
