...
- Name: visual.spec.ts >> Caso 2 — Menu Lateral >> 2.1 — Painel de propriedades deve aparecer ao selecionar um elemento
- Location: zTestesVisuais/testes-automatizados/visual.spec.ts:112:7
...
Call log:
  - waiting for locator('[data-testid="toolbar-rectangle"]')
    - locator resolved to <input type="radio" aria-label="Rectangle" aria-keyshortcuts="R or 2" name="editor-current-shape" data-testid="toolbar-rectangle" id="kDw4Aotsf_qLWyh9gFIpw-undefined" class="ToolIcon_type_radio ToolIcon_size_medium"/>
