...
- Name: visual.spec.ts >> Caso 2 — Menu Lateral >> 2.4 — Alterações no painel devem refletir no elemento em tempo real
- Location: zTestesVisuais/testes-automatizados/visual.spec.ts:190:7
...
Call log:
  - waiting for locator('[data-testid="toolbar-rectangle"]')
    - locator resolved to <input type="radio" aria-label="Rectangle" aria-keyshortcuts="R or 2" name="editor-current-shape" data-testid="toolbar-rectangle" id="nTJ2AzqCgLzgGnIBSaE3Y-undefined" class="ToolIcon_type_radio ToolIcon_size_medium"/>
